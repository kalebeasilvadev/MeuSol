...
(function(root, factory) {
  ...
  TableExport.prototype = {
    ...
    formatConfig: {
       ...
       */
      xlsx: {
        defaultClass: "btn btn-info m-1 xlsx",
        buttonContent: "xlsx",
        mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        fileExtension: ".xlsx"
      },
      xlsm: {
        defaultClass: "btn btn-info m-1 xlsm",
        buttonContent: "xlsm",
        mimeType: "application/vnd.ms-excel.sheet.macroEnabled.main+xml",
        fileExtension: ".xlsm"
      },
      xlsb: {
        defaultClass: "btn btn-info m-1 xlsb",
        buttonContent: "xlsb",
       ...
       */
      xls: {
        defaultClass: "btn btn-info m-1 xls",
        buttonContent: "xls",
        separator: "\t",
       ...
       */
      csv: {
        defaultClass: "btn btn-info m-1 csv",
        buttonContent: "csv",
        separator: ",",
        mimeType: "text/csv",
        fileExtension: ".csv",
       ...
       */
      txt: {
        defaultClass: "btn btn-info m-1 txt",
        buttonContent: "txt",
        separator: "  ",
        mimeType: "text/plain",
        fileExtension: ".txt",
